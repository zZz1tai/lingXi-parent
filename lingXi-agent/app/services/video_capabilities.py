"""Deterministic Wanx model capability rules shared by analysis and transport."""
...
def get_model_version(model: str) -> str:
    """Return the capability family encoded in a Wanx model name."""
...
def should_include_duration(model: str) -> bool:
    ...
    return get_model_version(model) in ("2.1-turbo", "2.5", "2.6")
